		...
		<div class="row g-0  min-h-400px"> <!-- .vh-100 hack-->
			...
			<div class="col-md overflow-hidden bg-color-layout p-3 p-lg-5 rounded-bottom-4 rounded-bottom-left-0" data-aos="fade-left" data-aos-delay="100">
				...
				<div class="w-100 d-flex align-items-center justify-content-between">
					<h6 class="subline text-action-1"><?= /*translators:Carte d'identité */ __('Identity', 'wa-golfs' ); ?></h6>
					<div>
				...
				<div class="row row-cols-1 row-cols-md-2 g-4 pt-3 py-2 py-md-3">
					...
					<div class="col d-flex align-items-center mt-2">
						...
						<div>
						<h6 class="fw-bold"><?= esc_html__( 'Location', 'wa-golfs' ); ?></h6>
					...
					<div class="col d-flex align-items-center mt-2">
						...
						<div>
						<h6 class="fw-bold"><?= esc_html__( 'Area (in ha)', 'wa-golfs' ); ?></h6>
					...
					<div class="col d-flex align-items-center mt-2">
						...
						<div>
						<h6 class="fw-bold"><?= esc_html__( 'Number of people', 'wa-golfs' ); ?></h6>
					...
					<div class="col d-flex align-items-center mt-2">
						...
						<div>
						<h6 class="fw-bold"><?= esc_html__( 'Livestock', 'wa-golfs' ); ?></h6>
					...
					<div class="col d-flex align-items-center mt-2">
						...
						<div>
						<h6 class="fw-bold"><?= esc_html__( 'Label', 'wa-golfs' ); ?></h6>
				...
				<div class="row row-cols-1 row-cols-md-1 g-4 py-2 py-md-3">
					...
					<div class="col d-flex align-items-center mt-2">
						...
						<div>
						<h6 class="fw-bold"><?= esc_html__( 'Commercialization', 'wa-golfs' ); ?></h6>
  ...
  <div class="container-fluid px-0">
      ...
      <div class="col-lg-5 col-xl-5 sticky-top mt-0 mt-lg-5 order-last order-lg-first" style="top: var(--waff-header-height-reduced, 0px)" data-aos="fade-down" data-aos-delay="300">
        <div class="inner-sticky bg-color-bg p-4 p-lg-5 rounded-end-4 rounded-bottom-right-0">
          ...
          <div class="row row-cols-1 row-cols-md-2">
            <div class="col">
              <h6 class="subline --text-action-1"><?= /*translators:Répartition */ __('Diagram', 'wa-golfs'); ?></h6>
            ...
            <div class="col">
				<h6 class="subline --text-action-1"><?= /*translators:Thematiques */ __('Thematics', 'wa-golfs'); ?></h6>
			...
			<!-- -->
			<h6 class="subline --text-action-1 mt-5"><?= esc_html__( 'Report.s', 'wa-golfs' ); ?></h6>
			...
			<h6 class="text-action-1"><?= esc_html__( 'Viability.s', 'wa-golfs' ); ?></h6>
			...
			<h6 class="text-action-1"><?= esc_html__( 'Vivability.s', 'wa-golfs' ); ?></h6>
			...
			<h6 class="text-action-1"><?= esc_html__( 'Skill.s', 'wa-golfs' ); ?></h6>
			...
			<h6 class="text-action-1"><?= esc_html__( 'Installation period', 'wa-golfs' ); ?></h6>
			...
			<h6 class="text-action-1"><?= esc_html__( 'Transmission / association', 'wa-golfs' ); ?></h6>
			...
			<h6 class="subline --text-action-1 mt-5"><?= /*translators:Galerie */ __('Gallery', 'wa-golfs'); ?></h6>
			<!-- Begin: Gallery row -->
			...
			<h6 class="subline --text-action-1 mt-5"><?= /*translators:Vidéo */ __('Video', 'wa-golfs'); ?></h6>
			<!-- Begin: Video row -->
			<div class="row row-cols-sm-2 row-cols-lg-3 mt-2 mb-6 g-4">
			...
			<h6 class="subline --text-action-1 mt-5"><?= /*translators:Files */ __('Files', 'wa-golfs'); ?></h6>
			<!-- Begin: Video row -->
			<div class="row row-cols-sm-2 row-cols-lg-3 mt-2 mb-6 g-4">
        ...
        <div class="bottom-sticky p-4 p-lg-5 bg-color-layout-2 rounded-top-4 rounded-top-left-0">
			...
			<h6 class="subline --text-action-1"><?= /*translators:Avec le soutien opérationnel de... */ __('With the operational support of...', 'wa-golfs'); ?></h6>
			...
			<div class="d-flex justify-content-between align-items-end">
				...
				<div>
					...
					<a class="btn btn-action-1 btn-sm btn-transition-scale mt-3 --flex-fill --w-100 px-2 py-0" href="<?= add_query_arg(array('form_type' => 'operation', 'ID' => $relationships_operation_post_id),$contact_permalink) ?>"><?= __('Contact us', 'wa-golfs'); ?></a>
				</div>
			</div>
		</div>
		<?php endforeach; ?>
		...
		<div class="bottom-sticky p-4 p-lg-5 bg-color-layout rounded-end-4 rounded-top-right-0">
			...
			<div>
				<h6 class="subline --text-action-1"><?= /*translators:Contactez votre structure d'accompagnement local */ __('Contact your local support structure', 'wa-golfs'); ?></h6>
		...
		<?php if (!empty($d_stage_opentovisit) || !empty($d_stage_opentostage)) { ?>
			<div class="d-flex align-items-center justify-content-center mx-4 mx-md-0 p-2 py-md-3 px-md-4 py-xl-4 px-xl-5 bg-body rounded-4 rounded-left-0 shadow mt-6">
				...
				<div class="d-lg-flex d-inline-block align-items-center px-1 px-lg-0">
					...
					<div>
					<h6 class="fw-bold text-action-1 my-2 my-lg-3"><?= esc_html__( 'Visit farm', 'wa-golfs' ); ?></h6>
					<p class="mb-0 small-lg"><span class="visually-hidden"><?= esc_html__( 'Farm is open to visit :', 'wa-golfs' ); ?></span><?= WaffTwo\Core\waff_implode_options(', ', $d_stage_opentovisit, $options_d_stage_opentovisit); ?></p>
					<a class="btn btn-action-1 btn-sm btn-transition-scale mt-3 --flex-fill --w-100 px-2 py-0" href="<?= esc_url(add_query_arg(array('form_type' => 'visit', 'ID' => $post->ID),$contact_permalink)) ?>"><?= esc_html__( 'Book a visit', 'wa-golfs' ); ?></a>
					</div>
				</div>
				<div class="d-none d-lg-flex align-items-center justify-content-center px-2 px-md-4 px-xl-5">
				...
				<div class="d-lg-flex d-inline-block align-items-center px-1 px-lg-0">
					...
					<div>
					<h6 class="fw-bold text-action-1 my-2 my-lg-3"><?= esc_html__( 'Open to stage', 'wa-golfs' ); ?></h6>
					<p class="mb-0 small-lg"><span class="visually-hidden"><?= esc_html__( 'Farm is open to stage :', 'wa-golfs' ); ?></span><?= WaffTwo\Core\waff_implode_options(', ', $d_stage_opentostage, $options_d_stage_opentostage); ?></p>
					<a class="btn btn-action-1 btn-sm btn-transition-scale mt-3 --flex-fill --w-100 px-2 py-0" href="<?= esc_url(add_query_arg(array('form_type' => 'stage', 'ID' => $post->ID),$contact_permalink)) ?>"><?= esc_html__( 'Apply to a stage', 'wa-golfs' ); ?></a>
					</div>
				</div>
				...
				<!-- <div class="d-lg-flex d-inline-block align-items-center">
					...
					<div>
					<h6 class="fw-bold --text-action-1"><?= esc_html__( 'Download', 'wa-golfs' ); ?></h6>
	  ...
	  <?php if (!empty($knowledge_acquisitions)) : ?>
		<div class="my-2 my-lg-6 mb-2 mb-lg-10">
			<h6 class="subline --text-action-1"><?= __('Acquisition', 'wa-golfs'); ?></h6>
	...
	-->
					...
					<div class="d-flex align-items-center justify-content-center mt-3 text-action-1">
						...
						<div class="d-flex align-items-center flex-fill w-50">
							...
							<div>
								<?php if (!empty($f_general_address)) printf('<h6 class="fw-bold text-action-1 op-6">%s</h6>', __('Adresse', 'wa-golfs')); ?>
						...
						<div class="d-flex align-items-center flex-fill w-50">
							<!-- <i class="bi bi-bootstrap flex-shrink-0 me-2 me-md-3 h2 md-reset-fontsize text-action-1"></i> -->
							<div>
								<h6 class="fw-bold text-action-1 op-6"><?= __('Contact', 'wa-golfs'); ?></h6>
					...
					<div class="d-flex align-items-center justify-content-center mt-3 text-action-1">
						...
						<div class="d-flex align-items-center flex-fill w-50">
							...
							<div>
								<h6 class="fw-bold text-action-1 op-6"><?= __('Links', 'wa-golfs'); ?></h6>
								<?php 
						...
						<a class="btn btn-action-1 btn-transition-scale mt-4 flex-fill w-50" href="<?= add_query_arg(array('form_type' => 'farm', 'ID' => $relationships_farm_post_id),$contact_permalink) ?>"><?= __('Contact us', 'wa-golfs'); ?></a>
				...
				<div class="row row-cols-1 row-cols-md-3 mt-4 mb-4">
					...
					<div class="col d-flex align-items-center">
						...
						<div class="flex-fill pe-7 pe-md-0">
							<h6 class="d-none d-md-block subline text-transparent-action-2 text-start"><?= __('Previous knowledge', 'wa-golfs'); ?></h6>
					...
					<div class="col d-flex align-items-center">
						<div class="flex-fill ps-7 ps-md-0">
							<h6 class="d-none d-md-block subline text-transparent-action-2 text-end"><?= __('Next knowledge', 'wa-golfs'); ?></h6>
