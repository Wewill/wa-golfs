...
export default function Edit({ context: { postType, postId } }) {
  ...
  const d_identity_label_li = (d_identity_label || []).map((label, index) => (
    <li class="lead" key={index}>
      {label}
    </li>
  ));
  const d_identity_commercialization_p = (
    d_identity_commercialization || []
  ).map((label, index) => (
  ...
  return (
    <div {...blockProps}>
      <RichText
        placeholder={__("Sous-titre", "wa-golfs")}
        tagName="h4"
        allowedFormats={[]}
        disableLineBreaks
      ...
      <RichText
        placeholder={__("Introduction", "wa-golfs")}
        tagName="p"
        className="lead"
              ...
              <div class="row row-cols-1 row-cols-md-2 g-4 pt-3 py-2 py-md-5">
                {d_identity_location && (
                  <div class="col d-flex align-items-center">
                    ...
                    <div>
                      <h6 class="fw-bold">{__("Location", "wa-golfs")}</h6>
                ...
                {d_identity_area && (
                  <div class="col d-flex align-items-center">
                    <i class="bi bi-bootstrap flex-shrink-0 me-3 h4"></i>
                    <div>
                      <h6 class="fw-bold">{__("Area (in ha)", "wa-golfs")}</h6>
                ...
                {d_identity_number_of_people && (
                  <div class="col d-flex align-items-center">
                    ...
                    <div>
                      <h6 class="fw-bold">
                        {__("Number of people", "wa-golfs")}
                      </h6>
                      <p class="lead mb-0 mb-md-4">
                        {d_identity_number_of_people}
                      </p>
                    </div>
                  </div>
                ...
                {d_identity_livestock && (
                  <div class="col d-flex align-items-center">
                    <i class="bi bi-bootstrap flex-shrink-0 me-3 h4"></i>
                    <div>
                      <h6 class="fw-bold">{__("Livestock", "wa-golfs")}</h6>
                ...
                {d_identity_label && (
                  <div class="col d-flex align-items-center">
                    <i class="bi bi-bootstrap flex-shrink-0 me-3 h4"></i>
                    <div>
                      <h6 class="fw-bold">{__("Label", "wa-golfs")}</h6>
