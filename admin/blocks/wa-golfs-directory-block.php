<?php
/**
 * Plugin Name:       WA GOLFS Directory blocks
 ...
 */
function wa_golfs_directory_block() {
    // Register your block
	...
	wp_localize_script(
        'create-block-wa-golfs-directory-block', // This is the generated handle you need to replace with your actual block script handle
...
// add_action( 'init', 'wa_golfs_directory_block' );
add_action( 'init', 'wa_golfs_directory_block', 30 ); // Ensure load init after metabox.io action
