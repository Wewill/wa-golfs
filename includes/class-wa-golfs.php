...
class Wa_Golfs {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Wa_Golfs_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'WA_GOLFS_VERSION' ) ) {
			$this->version = WA_GOLFS_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'wa-golfs';
	 ...
	 *
	 * - Wa_Golfs_Loader. Orchestrates the hooks of the plugin.
	 * - Wa_Golfs_i18n. Defines internationalization functionality.
	 * - Wa_Golfs_Admin. Defines all hooks for the admin area.
	 * - Wa_Golfs_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wa-golfs-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wa-golfs-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-wa-golfs-admin.php';
	 ...
	 *
	 * Uses the Wa_Golfs_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Wa_Golfs_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Wa_Golfs_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Wa_Golfs_Loader    Orchestrates the hooks of the plugin.
	 */
